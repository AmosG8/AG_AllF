...
[a,b]=uigetfile; %a=filenmae
a=a(1:end-5);  % the script needs an avi filename that ends with ch and not ch1

ms=msGenerateVideoObj(b, a);
%ms = msGenerateVideoObj('C:\Users\Amos\Documents\science\Ca Analysis\Miniscope_Analysis-master\SingleFunctions','movie1_frame_300_300_10.46pfs_mag_2_puff-Ch'); 
%movie_2_for_arb_2_NEW_mag_1p4_puff-Ch1.tif
...
ms.time = linspace(0,ms.numFrames/10.46*1000,ms.numFrames);%AG added from Daniel Aharoni
...
%% BEHAV STUFF  % AG commented the following 22/6/16
% 
% %% Generate behav.m
