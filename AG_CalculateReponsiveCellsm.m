function [ResponiveCellsCellArray] = AG_CalculateReponsiveCells(SpontCellArray, StimCellArray)
    ...
    for StimDay=1:StimImagingDays
        for SpontDay=1:SpontImagingDays
            if strcmp (SpontCellArray{1,SpontDay}, StimCellArray{1,StimDay})
                ...
                for iFOV=2:StimFovs %2 b/e the first 2 rows have a non FOV info
